...
class TechNeedService extends StatelessWidget {
      ...
      body: Padding(
        ...
        child: GridView.builder(
          gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
            ...
            crossAxisSpacing: 10,
            mainAxisSpacing: 10,
            childAspectRatio: 0.65, // Adjusted ratio for 65% image
          ),
            ...
            return GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => TechIssueDetailPage(issue: issue),
                  ),
                );
              },
              child: Card(
                ...
                child: Column(
                  ...
                  children: [
                    // 🖼 Image (65% of the card height)
                    Expanded(
                      flex: 6, // 6 parts of 10 (60-65%)
                      child: ClipRRect(
                        borderRadius:
