                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder:
                                (context) => TechIssueDetailPage(
                                  issue: issue,
                                  onDecline:
                                      () => removeIssue(issue), // Callback
                                ),
                          ),
                        );
                      },
                            ...
                            Expanded(
                              ...
                              child: Padding(
                                ...
                                child: SingleChildScrollView(
                                  // ⬅️ Prevents overflow by enabling scrolling
                                  child: Column(
                                    crossAxisAlignment:
                                    ...
                                    children: [
                                      Text(
                                        ...
                                        overflow:
                                            TextOverflow
                                                .ellipsis, // ⬅️ Prevents text overflow
                                      ),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  ...
                                                  maxLines:
                                                      1, // ⬅️ Ensures text doesn’t overflow
                                                ),
                                                Text(
                                                  issue["email"],
                                                  style: const TextStyle(
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Text(
                                              ...
                                              maxLines:
                                                  1, // ⬅️ Limits address to one line
                                            ),
                                          ),
                                        ],
                                      ),
